...
with (fan.helloJsStep1.$pod)
{
  ...
  fan.helloJsStep1.JsLibWrapper.$type.$am('say',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('message','sys::Str',false)])).$am('make',139268,fan.sys.List.make(fan.sys.Param.$type,[]));
