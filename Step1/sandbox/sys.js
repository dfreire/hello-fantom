...
fan.sys.OutStream.prototype.w = function(b)
{
return this.write(b);
}
...
fan.sys.Str.toBuf = function(self)
{
var buf = new fan.sys.MemBuf();
buf.print(self);
return buf.flip();
...
with (fan.sys.Pod.$add('sys'))
{
  ...
  fan.sys.Obj.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Type.$type.$am('methods',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('facet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('hasFacet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false)])).$am('mixins',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('isMixin',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('of',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('isAbstract',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('qname',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isNullable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('signature',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pod',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isFinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fields',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('isGeneric',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isConst',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isVal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('slots',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEnum',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('args','sys::Obj[]?',true)])).$am('isFacet',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isClass',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('facets',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isSynthetic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fits',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false)])).$am('parameterize',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('params','[sys::Str:sys::Type]',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('slot',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('params',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toNonNullable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isInternal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isPublic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('inheritance',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('emptyList',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('field',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('toNullable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('base',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toListOf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('method',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)]));
  fan.sys.Buf.$type.$af('charset',73728,'sys::Charset').$af('size',73728,'sys::Int').$af('endian',73728,'sys::Endian').$af('capacity',73728,'sys::Int').$am('readUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDigest',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('algorithm','sys::Str',false)])).$am('writeChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('char','sys::Int',false)])).$am('unread',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('printLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('close',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pos',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('more',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeProps',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('props','[sys::Str:sys::Str]',false)])).$am('readU2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBool',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('writeF4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('random',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('size','sys::Int',false)])).$am('writeUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('dup',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('unreadChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('hmac',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('algorithm','sys::Str',false),new fan.sys.Param('key','sys::Buf',false)])).$am('readChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('readLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true)])).$am('writeObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('toBase64',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBufFully',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf?',false),new fan.sys.Param('n','sys::Int',false)])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('capacity','sys::Int',true)])).$am('writeF8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)])).$am('readDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',false)])).$am('set',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('byte','sys::Int',false)])).$am('writeChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('off','sys::Int',true),new fan.sys.Param('len','sys::Int',true)])).$am('readS1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('clear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('remaining',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllStr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('normalizeNewlines','sys::Bool',true)])).$am('fromHex',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('write',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('byte','sys::Int',false)])).$am('writeI2',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('read',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('internalMake',132,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeI4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('peek',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('d','sys::Decimal',false)])).$am('trim',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readStrToken',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true),new fan.sys.Param('c','|sys::Int->sys::Bool|?',true)])).$am('flip',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeI8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('fromBase64',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('eachLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::Str->sys::Void|',false)])).$am('peekChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readF8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeXml',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('flags','sys::Int',true)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('readProps',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fill',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('byte','sys::Int',false),new fan.sys.Param('times','sys::Int',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readF4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('in',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('print',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Obj?',false)])).$am('toHex',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('seek',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pos','sys::Int',false)])).$am('writeBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',true)])).$am('flush',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeBool',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('slice',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('range','sys::Range',false)])).$am('readAllLines',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('out',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.MemBuf.$type.$af('charset',73728,'sys::Charset').$af('size',73728,'sys::Int').$af('endian',73728,'sys::Endian').$af('capacity',73728,'sys::Int').$am('readUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDigest',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('algorithm','sys::Str',false)])).$am('writeChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('char','sys::Int',false)])).$am('unread',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('printLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('close',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pos',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeProps',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('props','[sys::Str:sys::Str]',false)])).$am('more',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBool',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('writeF4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('random',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('size','sys::Int',false)])).$am('init',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('dup',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('unreadChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('hmac',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('algorithm','sys::Str',false),new fan.sys.Param('key','sys::Buf',false)])).$am('readChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('readLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true)])).$am('writeObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('toBase64',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBufFully',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf?',false),new fan.sys.Param('n','sys::Int',false)])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('capacity','sys::Int',true)])).$am('writeF8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)])).$am('readDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',false)])).$am('set',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('byte','sys::Int',false)])).$am('writeChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('off','sys::Int',true),new fan.sys.Param('len','sys::Int',true)])).$am('readS1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('clear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('remaining',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllStr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('normalizeNewlines','sys::Bool',true)])).$am('fromHex',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('writeI2',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('write',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('byte','sys::Int',false)])).$am('read',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('peek',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeI4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('writeDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('d','sys::Decimal',false)])).$am('trim',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeI8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('flip',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readStrToken',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true),new fan.sys.Param('c','|sys::Int->sys::Bool|?',true)])).$am('readS8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('peekChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('eachLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::Str->sys::Void|',false)])).$am('fromBase64',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('readF8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeXml',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('flags','sys::Int',true)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('fill',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('byte','sys::Int',false),new fan.sys.Param('times','sys::Int',false)])).$am('readProps',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readF4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('in',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('print',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Obj?',false)])).$am('seek',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pos','sys::Int',false)])).$am('toHex',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',true)])).$am('flush',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeBool',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('slice',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('range','sys::Range',false)])).$am('out',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllLines',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.RegexMatcher.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('groupCount',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('matches',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('start',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('group','sys::Int',true)])).$am('group',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('group','sys::Int',true)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('end',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('group','sys::Int',true)]));
  fan.sys.Enum.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('doFromStr',36866,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false),new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',false)])).$am('ordinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ordinal','sys::Int',false),new fan.sys.Param('name','sys::Str',false)]));
  fan.sys.LogLevel.$type.$af('warn',106506,'sys::LogLevel').$af('silent',106506,'sys::LogLevel').$af('debug',106506,'sys::LogLevel').$af('info',106506,'sys::LogLevel').$af('err',106506,'sys::LogLevel').$af('vals',106498,'sys::LogLevel[]').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ordinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doFromStr',36866,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false),new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('make',133124,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('$ordinal','sys::Int',false),new fan.sys.Param('$name','sys::Str',false)])).$am('static$init',165890,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Weekday.$type.$af('sun',106506,'sys::Weekday').$af('fri',106506,'sys::Weekday').$af('thu',106506,'sys::Weekday').$af('vals',106498,'sys::Weekday[]').$af('wed',106506,'sys::Weekday').$af('mon',106506,'sys::Weekday').$af('sat',106506,'sys::Weekday').$af('tue',106506,'sys::Weekday').$am('localeFull',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('localeStartOfWeek',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('decrement',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('increment',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doFromStr',36866,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false),new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',false)])).$am('ordinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('localeAbbr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',133124,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('$ordinal','sys::Int',false),new fan.sys.Param('$name','sys::Str',false)])).$am('static$init',165890,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Range.$type.$am('last',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('exclusive',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('contains',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('i','sys::Int',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('inclusive',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('map',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int->sys::Obj?|',false)])).$am('offset',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('offset','sys::Int',false)])).$am('toList',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('end',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('max',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('random',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('makeInclusive',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('start','sys::Int',false),new fan.sys.Param('end','sys::Int',false)])).$am('makeExclusive',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('start','sys::Int',false),new fan.sys.Param('end','sys::Int',false)])).$am('start',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('each',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int->sys::Void|',false)])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('start','sys::Int',false),new fan.sys.Param('end','sys::Int',false),new fan.sys.Param('exclusive','sys::Bool',false)])).$am('first',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Num.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeGrouping',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toFloat',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeDecimal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('localeMinus',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNaN',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePercent',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePosInf',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',132,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toInt',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNegInf',40962,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Decimal.$type.$af('defVal',106498,'sys::Decimal').$am('mult',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Decimal',false)])).$am('localeGrouping',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toFloat',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('div',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Decimal',false)])).$am('localeDecimal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('localeNaN',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('abs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('localePercent',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePosInf',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('decrement',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Decimal',false)])).$am('increment',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Decimal',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('negate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Decimal',false)])).$am('max',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Decimal',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('mod',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Decimal',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('localeMinus',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toInt',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNegInf',40962,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Map.$type.$af('caseInsensitive',73728,'sys::Bool').$af('def',73728,'sys::V?').$af('ordered',73728,'sys::Bool').$am('ro',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('remove',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false)])).$am('set',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false),new fan.sys.Param('val','sys::V',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('instance$init$sys$Map',133120,fan.sys.List.make(fan.sys.Param.$type,[])).$am('add',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false),new fan.sys.Param('val','sys::V',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('clear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('getOrAdd',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false),new fan.sys.Param('valFunc','|sys::K->sys::V|',false)])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('any',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Bool|',false)])).$am('map',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Obj?|',false)])).$am('vals',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('all',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Bool|',false)])).$am('find',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Bool|',false)])).$am('addList',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('list','sys::V[]',false),new fan.sys.Param('c','|sys::V,sys::Int->sys::K|?',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('isRO',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('m','sys::M',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false),new fan.sys.Param('def','sys::V?',true)])).$am('keys',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('findAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Bool|',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('exclude',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Bool|',false)])).$am('isRW',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('join',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('separator','sys::Str',false),new fan.sys.Param('c','|sys::V,sys::K->sys::Str|?',true)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('reduce',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('init','sys::Obj?',false),new fan.sys.Param('c','|sys::Obj?,sys::V,sys::K->sys::Obj?|',false)])).$am('eachWhile',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Obj?|',false)])).$am('size',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('dup',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('containsKey',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::K',false)])).$am('setAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('m','sys::M',false)])).$am('setList',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('list','sys::V[]',false),new fan.sys.Param('c','|sys::V,sys::Int->sys::K|?',true)])).$am('each',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::K->sys::Void|',false)])).$am('rw',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false)]));
  fan.sys.Err.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.ConstErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Regex.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('matches',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('matcher',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str',false)])).$am('glob',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str',false)])).$am('split',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('limit','sys::Int',true)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  ...
  fan.sys.Charset.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('utf8',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('defVal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('utf16BE',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('utf16LE',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Void.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.ArgErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.InterruptedErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Time.$type.$af('defVal',106498,'sys::Time').$am('fromDuration',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('d','sys::Duration',false)])).$am('isMidnight',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDateTime',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('d','sys::Date',false),new fan.sys.Param('tz','sys::TimeZone',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('fromLocale',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('pattern','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hour',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('now',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tz','sys::TimeZone',true)])).$am('sec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toIso',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('nanoSec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('hour','sys::Int',false),new fan.sys.Param('min','sys::Int',false),new fan.sys.Param('sec','sys::Int',true),new fan.sys.Param('ns','sys::Int',true)])).$am('fromIso',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('toDuration',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.InStream.$type.$af('charset',335872,'sys::Charset').$af('endian',335872,'sys::Endian').$am('readUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('unread',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('skip',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('pipe',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',false),new fan.sys.Param('n','sys::Int?',true),new fan.sys.Param('close','sys::Bool',true)])).$am('close',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllStr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('normalizeNewlines','sys::Bool',true)])).$am('read',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('peek',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU2',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU1',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readU4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readStrToken',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true),new fan.sys.Param('c','|sys::Int->sys::Bool|?',true)])).$am('readBool',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('eachLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::Str->sys::Void|',false)])).$am('peekChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readS8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readF8',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('readProps',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readF4',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('unreadChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('readChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('readLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('max','sys::Int?',true)])).$am('readBufFully',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf?',false),new fan.sys.Param('n','sys::Int',false)])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('in','sys::InStream?',false)])).$am('readDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllLines',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readBuf',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',false)]));
  fan.sys.Int.$type.$af('defVal',106498,'sys::Int').$af('minVal',106498,'sys::Int').$af('maxVal',106498,'sys::Int').$am('mult',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('pow',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pow','sys::Int',false)])).$am('lower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeGrouping',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toFloat',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromDigit',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('radix','sys::Int',true)])).$am('localeDecimal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('localeNaN',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('abs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('base','sys::Int',true)])).$am('localeLower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isUpper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePercent',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeIsLower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('decrement',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('increment',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('isEven',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('shiftr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('or',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('mod',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('random',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range?',true)])).$am('isOdd',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isDigit',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('radix','sys::Int',true)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('localeMinus',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('and',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('not',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('shiftl',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('isAlpha',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDateTime',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tz','sys::TimeZone',true)])).$am('div',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('upper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('times',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int->sys::Void|',false)])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('radix','sys::Int',true),new fan.sys.Param('checked','sys::Bool',true)])).$am('equalsIgnoreCase',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ch','sys::Int',false)])).$am('localePosInf',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isSpace',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Int',false)])).$am('localeUpper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isLower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('xor',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Int',false)])).$am('negate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('max',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Int',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toChar',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeIsUpper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toHex',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('width','sys::Int?',true)])).$am('toDigit',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('radix','sys::Int',true)])).$am('isAlphaNum',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toInt',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNegInf',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDuration',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.TimeoutErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Unit.$type.$am('scale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('A',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('quantities',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('convertTo',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('scalar','sys::Float',false),new fan.sys.Param('unit','sys::Unit',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('K',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('kg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('quantity',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('quantity','sys::Str',false)])).$am('offset',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('symbol',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('list',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('m',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('mol',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('sec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',139268,fan.sys.List.make(fan.sys.Param.$type,[])).$am('cd',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.UnknownFacetErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Date.$type.$af('defVal',106498,'sys::Date').$am('toDateTime',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Time',false),new fan.sys.Param('tz','sys::TimeZone',true)])).$am('today',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tz','sys::TimeZone',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isToday',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('midnight',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tz','sys::TimeZone',true)])).$am('weekday',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('fromLocale',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('pattern','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('lastOfMonth',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('year',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('firstOfMonth',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('days','sys::Duration',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('days','sys::Date',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isTomorrow',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('dayOfYear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isYesterday',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('month',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toIso',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('day',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false),new fan.sys.Param('month','sys::Month',false),new fan.sys.Param('day','sys::Int',false)])).$am('fromIso',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)]));
  fan.sys.IndexErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.CancelledErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Slot.$type.$am('facet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('hasFacet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false)])).$am('findFunc',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('facets',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('isSynthetic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isAbstract',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('qname',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findField',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isPrivate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('signature',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isMethod',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isOverride',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('findMethod',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('isNative',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isConst',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('parent',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isVirtual',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isInternal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isPublic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isProtected',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isStatic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',132,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isCtor',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isField',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Field.$type.$am('hasFacet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false)])).$am('facet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('set',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('instance','sys::Obj?',false),new fan.sys.Param('value','sys::Obj?',false)])).$am('facets',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findFunc',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('type',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('isSynthetic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('makeSetFunc',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('vals','[sys::Field:sys::Obj?]',false)])).$am('isAbstract',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('qname',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findField',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isPrivate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('signature',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isMethod',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isOverride',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('findMethod',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('instance','sys::Obj?',true)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('isNative',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('parent',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isConst',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isVirtual',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isPublic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isInternal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isProtected',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isStatic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isField',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isCtor',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Pod.$type.$am('locale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('def','sys::Str?',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('type',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('meta',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('version',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('of',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('file',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('config',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('def','sys::Str?',true)])).$am('types',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('depends',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('files',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('list',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('uri',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('log',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('load',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('in','sys::InStream',false)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('props',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false),new fan.sys.Param('maxAge','sys::Duration',false)]));
  fan.sys.Method.$type.$am('call',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',true),new fan.sys.Param('b','sys::Obj?',true),new fan.sys.Param('c','sys::Obj?',true),new fan.sys.Param('d','sys::Obj?',true),new fan.sys.Param('e','sys::Obj?',true),new fan.sys.Param('f','sys::Obj?',true),new fan.sys.Param('g','sys::Obj?',true),new fan.sys.Param('h','sys::Obj?',true)])).$am('hasFacet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false)])).$am('facet',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Type',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('facets',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findFunc',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('callList',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isSynthetic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isAbstract',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('qname',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findField',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isPrivate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('func',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('returns',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('signature',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('isMethod',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isOverride',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findMethod',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('qname','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('callOn',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('target','sys::Obj?',false),new fan.sys.Param('args','sys::Obj[]?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('isNative',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('parent',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isConst',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isVirtual',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isPublic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isInternal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('params',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isProtected',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isStatic',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isField',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isCtor',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.UnknownSlotErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.TimeZone.$type.$am('listNames',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('dstAbbr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('defVal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('utc',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('dstOffset',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('cur',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('rel',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fullName',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('offset',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('stdAbbr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('listFullNames',40962,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.ParseErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.OutStream.$type.$af('xmlEscNewlines',106498,'sys::Int').$af('xmlEscUnicode',106498,'sys::Int').$af('charset',335872,'sys::Charset').$af('endian',335872,'sys::Endian').$af('xmlEscQuotes',106498,'sys::Int').$am('writeChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('char','sys::Int',false)])).$am('printLine',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('close',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeChars',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('off','sys::Int',true),new fan.sys.Param('len','sys::Int',true)])).$am('writeProps',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('props','[sys::Str:sys::Str]',false),new fan.sys.Param('close','sys::Bool',true)])).$am('sync',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeI2',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('write',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('byte','sys::Int',false)])).$am('writeI4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('writeDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('d','sys::Decimal',false)])).$am('writeI8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('writeF4',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeXml',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('mode','sys::Int',true)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeUtf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('print',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Obj?',false)])).$am('writeBuf',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('buf','sys::Buf',false),new fan.sys.Param('n','sys::Int',true)])).$am('flush',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeBool',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('writeObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('static$init',165890,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream?',false)])).$am('writeF8',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false)]));
  fan.sys.StrBuf.$type.$af('capacity',73728,'sys::Int').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ch','sys::Int',false)])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('remove',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('set',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('ch','sys::Int',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('join',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false),new fan.sys.Param('sep','sys::Str',true)])).$am('removeRange',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range',false)])).$am('add',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('size',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('clear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('insert',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('x','sys::Obj?',false)])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('capacity','sys::Int',true)])).$am('out',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.UnknownTypeErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.DateTime.$type.$af('defVal',106498,'sys::DateTime').$am('nowUnique',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isMidnight',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toHttpStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ticks',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('dst',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('makeTicks',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ticks','sys::Int',false),new fan.sys.Param('tz','sys::TimeZone',true)])).$am('time',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('midnight',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toJava',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromLocale',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('str','sys::Str',false),new fan.sys.Param('pattern','sys::Str',false),new fan.sys.Param('tz','sys::TimeZone',true),new fan.sys.Param('checked','sys::Bool',true)])).$am('year',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('duration','sys::Duration',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('time','sys::DateTime',false)])).$am('toUtc',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('toRel',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('nowUtc',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tolerance','sys::Duration?',true)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('floor',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('accuracy','sys::Duration',false)])).$am('now',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tolerance','sys::Duration?',true)])).$am('nowTicks',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('month',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('day',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('nanoSec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false),new fan.sys.Param('month','sys::Month',false),new fan.sys.Param('day','sys::Int',false),new fan.sys.Param('hour','sys::Int',false),new fan.sys.Param('min','sys::Int',false),new fan.sys.Param('sec','sys::Int',true),new fan.sys.Param('ns','sys::Int',true),new fan.sys.Param('tz','sys::TimeZone',true)])).$am('fromIso',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('fromHttpStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('date',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('weekday',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('weekdayInMonth',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false),new fan.sys.Param('mon','sys::Month',false),new fan.sys.Param('weekday','sys::Weekday',false),new fan.sys.Param('pos','sys::Int',false)])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('boot',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isLeapYear',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('tzAbbr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hour',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('dayOfYear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('tz',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('sec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toIso',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromJava',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('millis','sys::Int',false),new fan.sys.Param('tz','sys::TimeZone',true)])).$am('toTimeZone',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tz','sys::TimeZone',false)]));
  fan.sys.Env.$type.$am('arch',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('workDir',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('args',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('locale',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pod','sys::Pod',false),new fan.sys.Param('key','sys::Str',false),new fan.sys.Param('def','sys::Str?',true),new fan.sys.Param('locale','sys::Locale',true)])).$am('gc',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('runtime',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('findAllFiles',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false)])).$am('idHash',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('config',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pod','sys::Pod',false),new fan.sys.Param('key','sys::Str',false),new fan.sys.Param('def','sys::Str?',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('os',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('platform',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('tempDir',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('index',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::Str',false)])).$am('homeDir',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('host',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('parent',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('in',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('exit',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('status','sys::Int',true)])).$am('vars',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compileScript',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','sys::File',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('err',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('findFile',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('findPodFile',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('podName','sys::Str',false)])).$am('findAllPodNames',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('cur',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('diagnostics',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('parent','sys::Env',true)])).$am('user',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('props',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pod','sys::Pod',false),new fan.sys.Param('uri','sys::Uri',false),new fan.sys.Param('maxAge','sys::Duration',false)])).$am('out',270336,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.FieldNotSetErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.NullErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Endian.$type.$af('little',106506,'sys::Endian').$af('big',106506,'sys::Endian').$af('vals',106498,'sys::Endian[]').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ordinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doFromStr',36866,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false),new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('make',133124,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('$ordinal','sys::Int',false),new fan.sys.Param('$name','sys::Str',false)])).$am('static$init',165890,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Log.$type.$af('level',73728,'sys::LogLevel').$am('warn',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',false),new fan.sys.Param('err','sys::Err?',true)])).$am('isErr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('debug',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',false),new fan.sys.Param('err','sys::Err?',true)])).$am('removeHandler',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('handler','|sys::LogRec->sys::Void|',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('info',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',false),new fan.sys.Param('err','sys::Err?',true)])).$am('handlers',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isInfo',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addHandler',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('handler','|sys::LogRec->sys::Void|',false)])).$am('find',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('list',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('isWarn',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('log',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('rec','sys::LogRec',false)])).$am('isEnabled',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('level','sys::LogLevel',false)])).$am('err',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',false),new fan.sys.Param('err','sys::Err?',true)])).$am('isDebug',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('register','sys::Bool',false)]));
  fan.sys.Month.$type.$af('dec',106506,'sys::Month').$af('mar',106506,'sys::Month').$af('jan',106506,'sys::Month').$af('vals',106498,'sys::Month[]').$af('may',106506,'sys::Month').$af('apr',106506,'sys::Month').$af('jul',106506,'sys::Month').$af('jun',106506,'sys::Month').$af('oct',106506,'sys::Month').$af('feb',106506,'sys::Month').$af('nov',106506,'sys::Month').$af('sep',106506,'sys::Month').$af('aug',106506,'sys::Month').$am('localeFull',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('decrement',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('increment',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ordinal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doFromStr',36866,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false),new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('checked','sys::Bool',false)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('localeAbbr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('numDays',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('year','sys::Int',false)])).$am('make',133124,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('$ordinal','sys::Int',false),new fan.sys.Param('$name','sys::Str',false)])).$am('static$init',165890,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.UnresolvedErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.List.$type.$af('size',73728,'sys::Int').$af('capacity',73728,'sys::Int').$am('indexSame',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false),new fan.sys.Param('offset','sys::Int',true)])).$am('removeSame',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false)])).$am('last',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('containsAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('list','sys::L',false)])).$am('contains',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false)])).$am('pop',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('of',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('makeObj',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('capacity','sys::Int',false)])).$am('any',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('insertAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('list','sys::L',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('index',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false),new fan.sys.Param('offset','sys::Int',true)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('list','sys::L',false)])).$am('binarySearch',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('key','sys::V',false),new fan.sys.Param('c','|sys::V,sys::V->sys::Int|?',true)])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('findAll',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('random',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('getSafe',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('def','sys::V?',true)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('reduce',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('init','sys::Obj?',false),new fan.sys.Param('c','|sys::Obj?,sys::V,sys::Int->sys::Obj?|',false)])).$am('eachWhile',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Obj?|',false)])).$am('dup',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('removeAt',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('findType',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false)])).$am('eachRange',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range',false),new fan.sys.Param('c','|sys::V,sys::Int->sys::Void|',false)])).$am('each',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Void|',false)])).$am('sortr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::V->sys::Int|?',true)])).$am('rw',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('of','sys::Type',false),new fan.sys.Param('capacity','sys::Int',false)])).$am('ro',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('sort',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::V->sys::Int|?',true)])).$am('unique',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('containsAny',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('list','sys::L',false)])).$am('remove',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false)])).$am('set',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('item','sys::V',false)])).$am('findIndex',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('add',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false)])).$am('push',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false)])).$am('clear',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('flatten',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('union',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::L',false)])).$am('map',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Obj?|',false)])).$am('peek',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trim',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('eachr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Void|',false)])).$am('find',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('all',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('moveTo',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('item','sys::V',false),new fan.sys.Param('toIndex','sys::Int',false)])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::V->sys::Int|?',true)])).$am('intersection',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::L',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('reverse',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isRO',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('max',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::V->sys::Int|?',true)])).$am('fill',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('val','sys::V',false),new fan.sys.Param('times','sys::Int',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('exclude',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Bool|',false)])).$am('isRW',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('join',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('separator','sys::Str',true),new fan.sys.Param('c','|sys::V,sys::Int->sys::Str|?',true)])).$am('removeRange',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range',false)])).$am('slice',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('range','sys::Range',false)])).$am('swap',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('indexA','sys::Int',false),new fan.sys.Param('indexB','sys::Int',false)])).$am('insert',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('item','sys::V',false)])).$am('first',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('eachrWhile',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::V,sys::Int->sys::Obj?|',false)]));
  fan.sys.NameErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Version.$type.$af('defVal',106498,'sys::Version').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('segments',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minor',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('build',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('version','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('segments','sys::Int[]',false)])).$am('major',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('patch',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Test.$type.$am('curTestMethod',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('verify',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('cond','sys::Bool',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('verifyEq',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('b','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('fail',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str?',true)])).$am('verifyFalse',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('cond','sys::Bool',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('setup',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('verifySame',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('b','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('verifyNotSame',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('b','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('tempDir',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('verifyErr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('errType','sys::Type',false),new fan.sys.Param('c','|sys::Test->sys::Void|',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('verifyType',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false),new fan.sys.Param('t','sys::Type',false)])).$am('verifyNotEq',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('b','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('verifyNull',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('verifyNotNull',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::Obj?',false),new fan.sys.Param('msg','sys::Str?',true)])).$am('make',4100,fan.sys.List.make(fan.sys.Param.$type,[])).$am('teardown',270336,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.TestErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str?',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Str.$type.$af('defVal',106498,'sys::Str').$am('lower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toFloat',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('checked','sys::Bool',true)])).$am('isAscii',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('contains',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('toXml',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compareIgnoreCase',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('isEmpty',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('indexrIgnoreCase',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('offset','sys::Int',true)])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('quote','sys::Int?',true),new fan.sys.Param('escapeUnicode','sys::Bool',true)])).$am('localeLower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('any',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int,sys::Int->sys::Bool|',false)])).$am('isUpper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('spaces',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('n','sys::Int',false)])).$am('index',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('offset','sys::Int',true)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('justl',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('width','sys::Int',false)])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false)])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('justr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('width','sys::Int',false)])).$am('localeCompare',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('getSafe',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('index','sys::Int',false),new fan.sys.Param('def','sys::Int',true)])).$am('padl',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('width','sys::Int',false),new fan.sys.Param('char','sys::Int',true)])).$am('capitalize',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('trimEnd',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('size',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('padr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('width','sys::Int',false),new fan.sys.Param('char','sys::Int',true)])).$am('split',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('separator','sys::Int?',true),new fan.sys.Param('trim','sys::Bool',true)])).$am('each',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int,sys::Int->sys::Void|',false)])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isAlpha',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toBool',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('checked','sys::Bool',true)])).$am('splitLines',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeCapitalize',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('numNewlines',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('upper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromDisplayName',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('checked','sys::Bool',true)])).$am('equalsIgnoreCase',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('trim',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('eachr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int,sys::Int->sys::Void|',false)])).$am('isSpace',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('all',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::Int,sys::Int->sys::Bool|',false)])).$am('localeUpper',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isLower',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toUri',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('startsWith',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('reverse',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('containsChar',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ch','sys::Int',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('charset','sys::Charset',true)])).$am('in',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeDecapitalize',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('replace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('from','sys::Str',false),new fan.sys.Param('to','sys::Str',false)])).$am('indexIgnoreCase',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('offset','sys::Int',true)])).$am('isAlphaNum',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('intern',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDisplayName',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('slice',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('range','sys::Range',false)])).$am('endsWith',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('toInt',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('radix','sys::Int',true),new fan.sys.Param('checked','sys::Bool',true)])).$am('decapitalize',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('indexr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('offset','sys::Int',true)])).$am('trimStart',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Duration.$type.$af('defVal',106498,'sys::Duration').$af('maxVal',106498,'sys::Duration').$af('minVal',106498,'sys::Duration').$am('mult',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('ticks',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('div',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('abs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDay',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toMin',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('toSec',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Duration',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('boot',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('negate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Duration',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('uptime',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('floor',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('accuracy','sys::Duration',false)])).$am('now',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('nowTicks',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toHour',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toIso',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromIso',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ticks','sys::Int',false)])).$am('toMillis',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Locale.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('use',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('func','|sys::This->sys::Void|',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('lang',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('country',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('cur',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('setCur',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('locale','sys::Locale',false)])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.MimeType.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('charset',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('params',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('parseParams',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('mediaType',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('subType',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('forExt',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('ext','sys::Str',false)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Func.$type.$am('call',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('a','sys::A',true),new fan.sys.Param('b','sys::B',true),new fan.sys.Param('c','sys::C',true),new fan.sys.Param('d','sys::D',true),new fan.sys.Param('e','sys::E',true),new fan.sys.Param('f','sys::F',true),new fan.sys.Param('g','sys::G',true),new fan.sys.Param('h','sys::H',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('callOn',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('target','sys::Obj?',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('params',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('callList',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('arity',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('retype',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('t','sys::Type',false)])).$am('method',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('returns',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('bind',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('args','sys::Obj?[]',false)]));
  fan.sys.NotImmutableErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Uri.$type.$af('defVal',106498,'sys::Uri').$am('checkName',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false)])).$am('sliceToPathAbs',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('ext',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('scheme',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('basename',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('mimeType',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('decodeQuery',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false)])).$am('isPathAbs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('encode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('toAppend','sys::Uri',false)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('host',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isRel',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('get',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('base','sys::Obj?',true),new fan.sys.Param('checked','sys::Bool',true)])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('parent',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pathStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('queryStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('frag',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('decode',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('relToAuth',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('encodeQuery',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('q','[sys::Str:sys::Str]',false)])).$am('plusName',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('asDir','sys::Bool',true)])).$am('auth',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('port',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('relTo',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('base','sys::Uri',false)])).$am('isAbs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plusSlash',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('query',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isDir',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isPathOnly',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isName',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false)])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('path',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('userInfo',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pathOnly',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('slice',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Range',false)])).$am('toFile',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plusQuery',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('query','[sys::Str:sys::Str]?',false)]));
  fan.sys.Float.$type.$af('defVal',106498,'sys::Float').$af('negInf',106498,'sys::Float').$af('pi',106498,'sys::Float').$af('nan',106498,'sys::Float').$af('posInf',106498,'sys::Float').$af('e',106498,'sys::Float').$am('mult',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('atan',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pow',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pow','sys::Float',false)])).$am('localeGrouping',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('cos',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toFloat',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeDecimal',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('round',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('toRadians',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('tanh',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNaN',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('abs',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePercent',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('bits32',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('decrement',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('increment',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('plus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('cosh',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('minus',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('pattern','sys::Str?',true)])).$am('mod',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('compare',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('random',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('sinh',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('log',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeMinus',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('exp',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('floor',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('makeBits32',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('bits','sys::Int',false)])).$am('tan',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('asin',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ceil',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('div',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Float',false)])).$am('approx',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('r','sys::Float',false),new fan.sys.Param('tolerance','sys::Float?',true)])).$am('atan2',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('y','sys::Float',false),new fan.sys.Param('x','sys::Float',false)])).$am('toDecimal',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('bits',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toDegrees',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localePosInf',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('acos',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('min',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Float',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('negate',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('max',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Float',false)])).$am('sqrt',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('log10',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('makeBits',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('bits','sys::Int',false)])).$am('sin',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toInt',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('localeNegInf',40962,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.UnknownPodErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.UnsupportedErr.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('cause',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('trace',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('msg',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('traceToStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('msg','sys::Str',true),new fan.sys.Param('cause','sys::Err?',true)]));
  fan.sys.Param.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('hasDefault',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('type',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Unsafe.$type.$am('val',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('val','sys::Obj?',false)]));
  fan.sys.LogRec.$type.$af('msg',73730,'sys::Str').$af('time',73730,'sys::DateTime').$af('level',73730,'sys::LogLevel').$af('err',73730,'sys::Err?').$af('logName',73730,'sys::Str').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('print',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('out','sys::OutStream',true)])).$am('make',8196,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('time','sys::DateTime',false),new fan.sys.Param('level','sys::LogLevel',false),new fan.sys.Param('logName','sys::Str',false),new fan.sys.Param('message','sys::Str',false),new fan.sys.Param('err','sys::Err?',true)]));
  fan.sys.This.$type.$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('toStr',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.File.$type.$af('modified',270337,'sys::DateTime?').$af('pathSep',106498,'sys::Str').$af('sep',106498,'sys::Str').$am('createTemp',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('prefix','sys::Str',true),new fan.sys.Param('suffix','sys::Str',true),new fan.sys.Param('dir','sys::File?',true)])).$am('listFiles',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('rename',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('newName','sys::Str',false)])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('createFile',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('ext',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('open',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('mode','sys::Str',true)])).$am('readAllBuf',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('writeProps',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('props','[sys::Str:sys::Str]',false)])).$am('basename',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('moveInto',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('dir','sys::File',false)])).$am('mimeType',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('os',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('osPath','sys::Str',false)])).$am('plus',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('path','sys::Uri',false),new fan.sys.Param('checkSlash','sys::Bool',true)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('copyInto',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('dir','sys::File',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('parent',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('osRoots',40962,fan.sys.List.make(fan.sys.Param.$type,[])).$am('pathStr',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('uri',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('create',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('size',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('mmap',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('mode','sys::Str',true),new fan.sys.Param('pos','sys::Int',true),new fan.sys.Param('size','sys::Int?',true)])).$am('writeObj',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('listDirs',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('make',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false),new fan.sys.Param('checkSlash','sys::Bool',true)])).$am('walk',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','|sys::File->sys::Void|',false)])).$am('createDir',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false)])).$am('isDir',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('normalize',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('copyTo',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('to','sys::File',false),new fan.sys.Param('options','[sys::Str:sys::Obj]?',true)])).$am('deleteOnExit',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('readAllStr',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('normalizeNewlines','sys::Bool',true)])).$am('name',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('path',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('delete',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('makeNew',4100,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false)])).$am('moveTo',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('to','sys::File',false)])).$am('eachLine',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::Str->sys::Void|',false)])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('readProps',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('list',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('in',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('bufferSize','sys::Int?',true)])).$am('exists',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('osPath',270337,fan.sys.List.make(fan.sys.Param.$type,[])).$am('out',270337,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('append','sys::Bool',true),new fan.sys.Param('bufferSize','sys::Int?',true)])).$am('readAllLines',8192,fan.sys.List.make(fan.sys.Param.$type,[]));
  fan.sys.Bool.$type.$af('defVal',106498,'sys::Bool').$am('typeof',270336,fan.sys.List.make(fan.sys.Param.$type,[])).$am('with',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('f','|sys::This->sys::Void|',false)])).$am('xor',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('toStr',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('equals',271360,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj?',false)])).$am('hash',271360,fan.sys.List.make(fan.sys.Param.$type,[])).$am('or',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('compare',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('that','sys::Obj',false)])).$am('toLocale',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('isImmutable',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('trap',270336,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('name','sys::Str',false),new fan.sys.Param('args','sys::Obj?[]?',false)])).$am('echo',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('x','sys::Obj?',false)])).$am('and',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('b','sys::Bool',false)])).$am('not',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('toCode',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('fromStr',40962,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('s','sys::Str',false),new fan.sys.Param('checked','sys::Bool',true)])).$am('privateMake',2052,fan.sys.List.make(fan.sys.Param.$type,[]));
}
