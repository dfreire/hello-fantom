      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              size = fan.sys.Str.toInt(fan.sys.Str.slice(tok,fan.sys.Range.make(0,-3)));
            }
            ;
          }
          ;
...
fan.gfx.Pen.fromStr = function(str,checked)
{
  ...
  try
  {
    ...
    if (b != null)
    {
      ...
      fan.sys.Str.split(fan.sys.Str.slice(str,fan.sys.Range.make(fan.sys.Int.plus(fan.sys.ObjUtil.coerce(b,fan.sys.Int.$type),1),fan.sys.ObjUtil.coerce(fan.sys.Str.index(str,"]"),fan.sys.Int.$type),true)),fan.sys.ObjUtil.coerce(44,fan.sys.Int.$type.toNullable())).each(fan.sys.Func.make(
      ...
      str = fan.sys.Str.trim(fan.sys.Str.slice(str,fan.sys.Range.make(0,fan.sys.ObjUtil.coerce(b,fan.sys.Int.$type),true)));
    }
    ;
    fan.sys.Str.split(str).each(fan.sys.Func.make(
      ...
      {
        var $_u11 = s;
        if (fan.sys.ObjUtil.equals($_u11,"capSquare"))
        {
          c = fan.gfx.Pen.m_capSquare;
        }
        else if (fan.sys.ObjUtil.equals($_u11,"capButt"))
        {
          c = fan.gfx.Pen.m_capButt;
        }
        else if (fan.sys.ObjUtil.equals($_u11,"capRound"))
        {
          c = fan.gfx.Pen.m_capRound;
        }
        else if (fan.sys.ObjUtil.equals($_u11,"joinMiter"))
        {
          j = fan.gfx.Pen.m_joinMiter;
        }
        else if (fan.sys.ObjUtil.equals($_u11,"joinBevel"))
        {
          j = fan.gfx.Pen.m_joinBevel;
        }
        else if (fan.sys.ObjUtil.equals($_u11,"joinRound"))
        {
    ...
    return fan.gfx.Pen.make(fan.sys.Func.make(
      ...
      function(it)
      {
        ...
        it.m_cap = c;
        it.m_join = j;
        it.m_dash = fan.sys.ObjUtil.coerce((function($this) { var $_u12 = d; if ($_u12 == null) return null; return fan.sys.ObjUtil.toImmutable($_u12); })($this),fan.sys.Type.find("sys::Int[]?"));
        return;
      }));
  }
  catch ($_u13)
...
{
  var $_u14 = this.m_cap;
  if (fan.sys.ObjUtil.equals($_u14,fan.gfx.Pen.m_capSquare))
  {
    return "square";
  }
  else if (fan.sys.ObjUtil.equals($_u14,fan.gfx.Pen.m_capButt))
  {
    return "butt";
  }
  else if (fan.sys.ObjUtil.equals($_u14,fan.gfx.Pen.m_capRound))
  {
    return "round";
  }
  else
...
{
  var $_u15 = this.m_join;
  if (fan.sys.ObjUtil.equals($_u15,fan.gfx.Pen.m_joinMiter))
  {
    return "miter";
  }
  else if (fan.sys.ObjUtil.equals($_u15,fan.gfx.Pen.m_joinRound))
  {
    return "round";
  }
  else if (fan.sys.ObjUtil.equals($_u15,fan.gfx.Pen.m_joinBevel))
  {
    return "bevel";
  }
  else
...
fan.gfx.Pen.prototype.toStr = function()
{
  ...
  var $_u16 = this.m_cap;
  if (fan.sys.ObjUtil.equals($_u16,fan.gfx.Pen.m_capButt))
  {
    s = fan.sys.Str.plus(s," capButt");
  }
  else if (fan.sys.ObjUtil.equals($_u16,fan.gfx.Pen.m_capRound))
  {
    s = fan.sys.Str.plus(s," capRound");
  }
  ;
  var $_u17 = this.m_join;
  if (fan.sys.ObjUtil.equals($_u17,fan.gfx.Pen.m_joinBevel))
  {
    s = fan.sys.Str.plus(s," joinBevel");
  }
  else if (fan.sys.ObjUtil.equals($_u17,fan.gfx.Pen.m_joinRound))
  {
...
fan.gfx.Point.fromStr = function(s,checked)
{
  ...
  try
  {
    ...
    return fan.gfx.Point.make(fan.sys.ObjUtil.coerce(fan.sys.Str.toInt(fan.sys.Str.trim(fan.sys.Str.slice(s,fan.sys.Range.make(0,fan.sys.ObjUtil.coerce(comma,fan.sys.Int.$type),true)))),fan.sys.Int.$type),fan.sys.ObjUtil.coerce(fan.sys.Str.toInt(fan.sys.Str.trim(fan.sys.Str.slice(s,fan.sys.Range.make(fan.sys.Int.plus(fan.sys.ObjUtil.coerce(comma,fan.sys.Int.$type),1),-1)))),fan.sys.Int.$type));
  }
  catch ($_u18)
  {
  }
...
fan.gfx.Halign.static$init = function()
{
  ...
  fan.gfx.Halign.m_vals = fan.sys.ObjUtil.coerce((function($this) { var $_u29 = fan.sys.List.make(fan.gfx.Halign.$type, [fan.gfx.Halign.m_left,fan.gfx.Halign.m_center,fan.gfx.Halign.m_right,fan.gfx.Halign.m_fill,fan.gfx.Halign.m_repeat]); if ($_u29 == null) return null; return fan.sys.ObjUtil.toImmutable($_u29); })(this),fan.sys.Type.find("gfx::Halign[]"));
  return;
}
...
fan.gfx.Valign.static$init = function()
{
  ...
  fan.gfx.Valign.m_vals = fan.sys.ObjUtil.coerce((function($this) { var $_u30 = fan.sys.List.make(fan.gfx.Valign.$type, [fan.gfx.Valign.m_top,fan.gfx.Valign.m_center,fan.gfx.Valign.m_bottom,fan.gfx.Valign.m_fill,fan.gfx.Valign.m_repeat]); if ($_u30 == null) return null; return fan.sys.ObjUtil.toImmutable($_u30); })(this),fan.sys.Type.find("gfx::Valign[]"));
  return;
}
...
fan.gfx.Orientation.static$init = function()
{
  ...
  fan.gfx.Orientation.m_vals = fan.sys.ObjUtil.coerce((function($this) { var $_u31 = fan.sys.List.make(fan.gfx.Orientation.$type, [fan.gfx.Orientation.m_horizontal,fan.gfx.Orientation.m_vertical]); if ($_u31 == null) return null; return fan.sys.ObjUtil.toImmutable($_u31); })(this),fan.sys.Type.find("gfx::Orientation[]"));
  return;
}
...
fan.gfx.GradientMode.static$init = function()
{
  ...
  fan.gfx.GradientMode.m_vals = fan.sys.ObjUtil.coerce((function($this) { var $_u32 = fan.sys.List.make(fan.gfx.GradientMode.$type, [fan.gfx.GradientMode.m_linear,fan.gfx.GradientMode.m_radial]); if ($_u32 == null) return null; return fan.sys.ObjUtil.toImmutable($_u32); })(this),fan.sys.Type.find("gfx::GradientMode[]"));
  return;
}
...
fan.gfx.Image.make = function(uri,checked)
{
  ...
  {
    $_u33 = fan.sys.Err.make($_u33);
    if ($_u33 instanceof fan.sys.Err)
    {
      var e = $_u33;
      var e;
      if (checked)
...
fan.gfx.Image.makeFile = function(f,checked)
{
  ...
  {
    $_u34 = fan.sys.Err.make($_u34);
    if ($_u34 instanceof fan.sys.Err)
    {
      var e = $_u34;
      var e;
      if (checked)
...
fan.gfx.Gradient.prototype.$ctor = function()
{
  ...
  this.m_stops = fan.sys.ObjUtil.coerce((function($this) { var $_u35 = fan.gfx.Gradient.m_defStops; if ($_u35 == null) return null; return fan.sys.ObjUtil.toImmutable($_u35); })(this),fan.sys.Type.find("gfx::GradientStop[]"));
  return;
}
...
fan.gfx.Gradient.makeStr$ = function(self,str)
{
  ...
  if (fan.sys.ObjUtil.equals(fan.sys.Str.get(str,-1),41))
  {
    ...
    ;
    str = fan.sys.Str.slice(str,fan.sys.Range.make(7,-2));
  }
  ;
  ...
  for (var i = 0; fan.sys.ObjUtil.compareLT(i,2); i = fan.sys.Int.increment(i))
  {
    ...
    {
      x = fan.sys.Str.toInt(fan.sys.Str.slice(xs,fan.sys.Range.make(0,-2)));
    ...
    else
    {
      ...
      {
        x = fan.sys.Str.toInt(fan.sys.Str.slice(xs,fan.sys.Range.make(0,-3)));
    ...
    {
      y = fan.sys.Str.toInt(fan.sys.Str.slice(ys,fan.sys.Range.make(0,-2)));
    ...
    else
    {
      ...
      {
        y = fan.sys.Str.toInt(fan.sys.Str.slice(ys,fan.sys.Range.make(0,-3)));
  ...
  for (var i = 2; fan.sys.ObjUtil.compareLT(i,parts.size()); i = fan.sys.Int.increment(i))
  {
    ...
    {
      stopColors.add(fan.sys.ObjUtil.coerce(fan.gfx.Color.fromStr(fan.sys.Str.slice(stopPart,fan.sys.Range.make(0,fan.sys.ObjUtil.coerce(space,fan.sys.Int.$type),true))),fan.gfx.Color.$type));
      stopPos.add(fan.sys.Str.slice(stopPart,fan.sys.Range.make(fan.sys.Int.plus(fan.sys.ObjUtil.coerce(space,fan.sys.Int.$type),1),-1)));
    }
    ;
  }
  ;
  ...
  ;
  self.m_stops = fan.sys.ObjUtil.coerce((function($this) { var $_u37 = fan.sys.ObjUtil.coerce(stopColors.map(fan.sys.Func.make(
...
fan.gfx.Gradient.loadUnit = function(name,symbol)
{
  try
  {
    return fan.sys.ObjUtil.coerce(fan.sys.Unit.find(name),fan.sys.Unit.$type);
  }
  catch ($_u40)
  {
    ...
    if ($_u40 instanceof fan.sys.Err)
    {
      var e = $_u40;
      var e;
      return fan.sys.ObjUtil.coerce(fan.sys.Unit.fromStr(fan.sys.Str.plus(fan.sys.Str.plus(fan.sys.Str.plus("",name),";"),symbol)),fan.sys.Unit.$type);
    }
    else
    {
      throw $_u40;
...
fan.gfx.Gradient.static$init = function()
{
  ...
  fan.gfx.Gradient.m_defStops = fan.sys.ObjUtil.coerce((function($this) { var $_u41 = fan.sys.List.make(fan.gfx.GradientStop.$type, [fan.gfx.GradientStop.make(fan.gfx.Color.m_white,fan.sys.Float.make(0.0)),fan.gfx.GradientStop.make(fan.gfx.Color.m_black,fan.sys.Float.make(1.0))]); if ($_u41 == null) return null; return fan.sys.ObjUtil.toImmutable($_u41); })(this),fan.sys.Type.find("gfx::GradientStop[]"));
  return;
}
...
{
  var $_u43 = s;
  if (fan.sys.ObjUtil.equals($_u43,fan.gfx.Border.m_styleSolid))
  {
    return "solid";
  }
  else if (fan.sys.ObjUtil.equals($_u43,fan.gfx.Border.m_styleInset))
  {
    return "inset";
  }
  else if (fan.sys.ObjUtil.equals($_u43,fan.gfx.Border.m_styleOutset))
  {
    return "outset";
  }
  else
...
fan.gfx.BorderParser.prototype.next = function()
{
  ...
  ;
  this.m_tok = fan.sys.Str.slice(this.m_str,fan.sys.Range.make(s,this.m_n,true));
  while (fan.sys.ObjUtil.compareLT(this.m_n,size) && fan.sys.ObjUtil.equals(fan.sys.Str.get(this.m_str,this.m_n),32))
  {
    this.m_n = fan.sys.Int.increment(this.m_n);
  }
...
fan.gfx.Color.makeHsv = function(h,s,v)
{
  ...
  if (fan.sys.ObjUtil.compareNE(s,fan.sys.Float.make(0.0)))
  {
    ...
    var $_u49 = fan.sys.Num.toInt(fan.sys.ObjUtil.coerce(i,fan.sys.Num.$type));
    if (fan.sys.ObjUtil.equals($_u49,0))
    {
      r = v;
      g = t;
      b = p;
    }
    else if (fan.sys.ObjUtil.equals($_u49,1))
    {
      r = q;
      g = v;
      b = p;
    }
    else if (fan.sys.ObjUtil.equals($_u49,2))
    {
      r = p;
      g = v;
      b = t;
    }
    else if (fan.sys.ObjUtil.equals($_u49,3))
    {
      r = p;
      g = q;
      b = v;
    }
    else if (fan.sys.ObjUtil.equals($_u49,4))
    {
      r = t;
      g = p;
      b = v;
    }
    else if (fan.sys.ObjUtil.equals($_u49,5))
    {
      r = v;
      g = p;
      b = q;
...
fan.gfx.Color.fromStr = function(s,checked)
{
  ...
  try
  {
    ...
    ;
    var sub = fan.sys.Str.slice(s,fan.sys.Range.make(1,-1));
    var hex = fan.sys.Str.toInt(sub,16);
    var $_u50 = fan.sys.Str.size(sub);
    if (fan.sys.ObjUtil.equals($_u50,3))
    {
