...
with (fan.dom.$pod)
{
  ...
  fan.dom.Doc.$type.$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('body',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('elem',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('id','sys::Str',false)])).$am('createElem',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('tagName','sys::Str',false),new fan.sys.Param('attrib','[sys::Str:sys::Str]?',true)])).$am('cookies',8192,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addCookie',8192,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','web::Cookie',false)])).$am('getCookiesStr',2560,fan.sys.List.make(fan.sys.Param.$type,[])).$am('addCookieStr',2560,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('c','sys::Str',false)]));
  ...
  fan.dom.Event.$type.$af('meta',73728,'[sys::Str:sys::Obj?]').$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('target',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('x',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('y',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('alt',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('ctrl',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('shift',8704,fan.sys.List.make(fan.sys.Param.$type,[]));
  ...
  fan.dom.Win.$type.$am('make',2052,fan.sys.List.make(fan.sys.Param.$type,[])).$am('cur',41474,fan.sys.List.make(fan.sys.Param.$type,[])).$am('doc',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('alert',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('obj','sys::Obj',false)])).$am('viewport',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('uri',8704,fan.sys.List.make(fan.sys.Param.$type,[])).$am('hyperlink',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('uri','sys::Uri',false)])).$am('reload',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('force','sys::Bool',true)])).$am('onEvent',8704,fan.sys.List.make(fan.sys.Param.$type,[new fan.sys.Param('type','sys::Str',false),new fan.sys.Param('useCapture','sys::Bool',false),new fan.sys.Param('handler','|dom::Event->sys::Void|',false)]));
